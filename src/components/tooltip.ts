...
export function initTooltip(): void {
  ...
  // Scrolling moves the anchor out from under the tip without firing mouseout.
  window.addEventListener('scroll', hideTooltip, true);
}

/** Force the tooltip closed. Call when the hovered element is about to be removed
 *  — swapping views mid-hover destroys the anchor before mouseout can fire, which
 *  otherwise leaves the tip stranded on screen. */
